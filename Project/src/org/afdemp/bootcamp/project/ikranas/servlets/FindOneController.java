 ...
 */
@WebServlet("/findOne")
public class FindOneController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindOneController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("proUserId").matches("[0-9]+")){
			...
			RequestDispatcher succdis = getServletContext().getRequestDispatcher("/findOneResults.jsp");
